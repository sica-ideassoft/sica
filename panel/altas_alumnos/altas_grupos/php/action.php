...
$check = mysql_query("SELECT * FROM grupo order by id_grupo desc");
...
$checgrupo = mysql_query("SELECT id_materia FROM grupo where
	id_materia='".$materia."'");
...
$query = mysql_query("INSERT INTO grupo(id_grupo,id_maestro,id_materia,grado,grupo) values (null,'$maestro','$materia','$grado','$grupo')");
}
}
