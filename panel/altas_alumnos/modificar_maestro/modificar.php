        ...
        <li class='has-sub admin '><a  href='#'><span class="icoAlumno">ALUMNOS</span></a>
         ...
         <li class='has-sub admin activo'><a  href='#'><span class='icoMaestro'>MAESTROS</span></a>
          ...
          <li><a href='../buscar_maestro/buscar_maestro.php'><span class="icoBuscar"><b>BUSCAR</b></span></a>
            ...
            <li><a class="activo" href='../modificar_maestro/modificar_maestro.php'><span  class='icoEditarActivo'><b>MODIFICAR/ELIMINAR</b></span></a>
            </li>
...
?>
  <form method="POST" action="php/modificado.php?id=<?php echo $id;?>" name="form1" class="form1">
    ...
    <table class='table1'>
      ...
      <tr>
        <td><input type="text" name="nombre"  id="nombre" value=<?php echo $alumno['nombre']; ?>></input></td>
...
<div id="flash" align="left"  >
  <img src="image/loader.gif" alt="">
          ...
          <a class="regresar" href="modificar_maestro.php">REGRESAR</a><span class="reg"></span>
        </td></tr>
      </table>
    </div>
