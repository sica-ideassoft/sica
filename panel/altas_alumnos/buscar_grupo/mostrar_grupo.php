...
<!-- incio de menu config -->
 ...
 <li class='has-sub admin activo'><a  href='#'><span class="icoGrupo">GRUPOS</span></a>
          <ul>
               ...
               <li><a  class='activo' href='../buscar_grupo/buscar_grupo.php'><span class="icoBuscarActivo"><b>BUSCAR</b></span></a>
            </li>
...
?>
        ...
        <tr>
        <td>
            <a class="regresar" href="buscar_grupo.php">REGRESAR</a><span class="reg"></span>
        </td>
        </tr>
        </table>
        </div>
