...
if(isset($_POST['nombre']) && isset($_POST['profesor']) && isset($_POST['fecha1']) && isset($_POST['fecha2'])&& isset($_POST['creditos']) && isset($_POST['calificacion']))
{
...
mysql_query("INSERT INTO materias(id_materia,nombre,profesor,fecha_inicio,fecha_fin,credito,cal_min,ip) values (null,'$nombre','$profesor','$fecha1','$fecha2','$creditos','$calificacion','$ip')");
