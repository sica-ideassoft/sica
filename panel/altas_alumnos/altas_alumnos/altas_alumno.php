      ...
      <section class="seccion1">
        ...
        <form action="" method="POST" name="form1" class="form1">
          ...
          <table class='table1'>
            ...
            <tr>
              <td><input type="text" nombre="nombre"  id="nombre" alt="nombre" ></td>
              <td><input type="text" nombre="paterno"  id="paterno" ></td>
              <td><input type="text" nombre="materno" id="materno" ></td>
